...
class PagesController extends Controller {
	...
	// method throttleError returns view 'throttle' (resources/views/throttle.blade.php)
	public function throttleError()
	{
		return view('pages.throttle');
	}

	// method noRecordsError returns view 'norecords' (resources/views/norecords.blade.php)
